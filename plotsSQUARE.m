...
title('Rotor Thrust vs Airspeed')
xlabel('Airspeed [m/s]')
ylabel('Rotor Thrust [N]')
legend('Rotor 1 - Lead Left','Rotor 2 - Rear Left','Rotor 3 - Rear Right','Rotor 4 - Lead Right','Location','northwest')
...
figure;
plot(flowV, powerROTORforcesquare(:,:,1),'-ro', flowV, powerROTORforcesquare(:,:,2),'-b+',...
    flowV, powerROTORforcesquare(:,:,3),'-ks',flowV, powerROTORforcesquare(:,:,4),'-gx')
...
figure(1001);
hold on
plot(flowV, sum(powerROTORdiamond,3)+powerPARASITIC, '-k')
plot(flowV, sum(powerROTORsquare,3)+powerPARASITIC, '-b')
plot(flowV, sum(powerROTORforcediamond,3)+powerPARASITIC, '--k')
plot(flowV, sum(powerROTORforcesquare,3)+powerPARASITIC, '--b')

% plot(flowV, powerPARASITIC, '-g')
plot(flowV, sum(powerROTORforcesquare,3),'--b')
plot(flowV, sum(powerROTORforcesquare,3)+powerPARASITIC, '-.k')
title('Rotor Power vs Airspeed')
xlabel('Airspeed [m/s]')
ylabel('Power [W]')
legend('Parasitic Power','Total Rotor Power - Square','Total Power - Square','Rotor 4 - Lead Right','Location','northwest')

plot(flowV, powerPARASITICsquare, '-g')
